  ...
  return (
    <div className="my-20 py-16 font-sans w-full  bg-gradient-to-r from-[#1a1832] via-[#49274b] to-[#a54657] text-gray-300  flex items-center justify-center">
      <div className="text-center px-4  ">
        ...
        <button
          className="bg-[#a54657] border border-white text-white text-sm font-semibold py-3 px-5 rounded-md transition-transform duration-300 transform hover:scale-110"
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="mb-5">
                <label
                  htmlFor="name"
                  className="block text-xl text-gray-300  font-medium mt-4"
                >
                  01 What's your name?
                </label>
                <input
              ...
              <div className="mb-5">
                <label
                  htmlFor="email"
                  className="block text-xl text-gray-300  font-medium mt-8"
                >
              ...
              <div className="mt-10">
                <label
                  htmlFor="message"
                  className="block text-xl text-gray-300  font-medium mt-5"
                >
                  03 Your message
                </label>
                <textarea
